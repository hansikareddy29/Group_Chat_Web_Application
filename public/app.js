...
// FEATURE: LOAD PREVIOUS MESSAGES
...
function renderMessage(data) {
    ...
    div.innerHTML = `
        <div class="message-header">${isMine ? "You" : data.username} <span style="font-size:10px; opacity:0.6">${data.timestamp}</span></div>
